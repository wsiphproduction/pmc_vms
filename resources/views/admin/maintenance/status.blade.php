                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <form action="{{route('maintenance.status.destroy', ['status' => $item->id])}}" method="POST">
                                                        ...
                                                        @endif
                                                        @if($delete)
                                                        <button onclick="return confirm('Are you sure you want to delete unit status?')" type="submit" class="btn red btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Delete"><i class="fa fa-minus-circle"></i></button>
                                                        @else
