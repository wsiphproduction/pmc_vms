                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <form action="{{route('maintenance.mechanic.destroy', ['mechanic' => $item->id])}}" method="POST">
                                                        ...
                                                        @csrf
                                                        @if($edit)
                                                        <a  href="{{ route('maintenance.mechanic.edit', ['mechanic' => $item->id]) }}" class="btn green btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                                        @else
                                                        <button disabled href="{{ route('maintenance.mechanic.edit', ['mechanic' => $item->id]) }}" class="btn green btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></button>
                                                        @endif
                                                        @if($delete)
                                                        <button onclick="return confirm('Are you sure you want to delete mechanic?')" type="submit" class="btn red btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Delete"><i class="fa fa-minus-circle"></i></button>
                                                        @else
