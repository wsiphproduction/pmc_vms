                              ...
                              <div class="form-group col-md-12">
                                 ...
                                 <form role="form" action="{{ route('vehicle.dispatch.create', ['deptId' => $request->dept]) }}" method="POST">
                                    ...
                                    <div class="form-group col-md-12">
                                       ...
                                       <div class="alert alert-info">
                                          <center style="font-family: times;"><b>TRIP TICKET FORM</b><br><small style="color:red;">Note: Trip ticket number will be given after submission of this form</small></center>
                                       </div>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="input-group col-md-12">
                                             <div class="input-icon">
                                                ...
                                                <input name="do" class="form-control" size="16" type="text">
                                             </div>
                                             <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                          </div>
                                          @else
                                          <div class="input-group date form_datetime_time col-md-12">
                                             <div class="input-icon">
                                                <i class="fa fa-calendar font-yellow"></i>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-4">
                                             <select name="vehicles" class="bs-select form-control" id="vcostcode" onchange="update_vehiclecostcode();" required>
                                    ...
                                    <div class="form-group col-md-12">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="input-icon">
                                             <i class="fa fa-globe font-yellow"></i>
                                             <input required type="text" class="form-control" name="destination" placeholder="Destination" value="{{ $request->destination }}" required>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                       <div class="col-md-3">
                                          ...
                                          <div class="input-icon">
                                             ...
                                             <input type="number" step="any" min="0.00001" id="odom_start" class="form-control" name="odom_start" placeholder="Odometer Start" required>
                                          </div>
                                       </div>
                                    ...
                                    <div class="form-group col-md-12">
                                       ...
                                       <button disabled style="float: right;" data-toggle='modal' class='btn yellow' href='#close-{{ $request->id }}'><span class='glyphicon glyphicon-remove-circle'></span> Close
                                       </button>
                                       <button disabled style="float: right;" data-toggle='modal' class='btn red' href='#cancel-{{ $request->id }}'><span class='glyphicon glyphicon-remove-circle'></span> Cancel
                                       </button>
                                 ...
                                 <div class="modal fade" id="cancel-{{ $request->id }}" tabindex="-1" role="basic" aria-hidden="true">
                                    <div class="modal-dialog">
                                       <form action="{{ route('vehicle.request.cancel',  ['id' =>  $request->id]) }}" method="POST">
                                          @csrf
                                          {{ method_field('POST') }}
                                 ...
                                 <div class="modal fade" id="close-{{ $request->id }}" tabindex="-1" role="basic" aria-hidden="true">
                                    <div class="modal-dialog">
                                       <form action="{{ route('vehicle.request.trip_completed_addDispatch',  ['id' =>  $request->id]) }}" method="POST">
                                          @csrf
                                          {{ method_field('POST') }}
                                          <div class="modal-content">
                                             <div class="modal-header">
