    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <i class="fa fa-certificate"></i> <small>&nbsp;&nbsp;FMS</small>
                </h3>
            </div>
        </div>
                            ...
                            <div class="tab-pane active">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <form role="form" action="{{route('vehicle.report.fms_vehicles_department')}}" method="GET">
                                            <div class="col-md-3">
                                                ...
                                                <select name="dept" id="dept" class="form-control" required>
                                                    ...
                                                    @if(isset($dept)) 
                                                        @foreach($dept as $key => $item)
                                                            @if( $item['name'] == request()->query('dept'))
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase"> FMS Vehicle List Per Department</span>
                                </div>                             
                            <div class="portlet-body">                                
