    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <i class="fa fa-certificate"></i> TOP 10 <small>&nbsp;&nbsp;Vehicles by distance travelled</small>
                </h3>
            </div>
        </div>
                            ...
                            <div class="tab-pane active">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <form role="form" action="{{route('vehicle.report.total.distance')}}" method="GET">
                                            <div class="col-md-3">
                                    ...
                                    <ul class="list-inline">
                                        <li>
                                            <form method="POST" action="{{route('vehicle.report.exportToExcel')}} ">
                                                ...
                                                <button class="btn btn-circle blue" name="distance_travel" id="excel-b"><i class="fa fa-file-excel-o"></i> Excel</button>
                                            </form>
                                        </li>
                                        <li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <tbody>
                                            @foreach ($items as $item)
                                                ...
                                                <tr>
                                                    <td>{{$item->label}}</td>
                                                    <td>{{$item->odometer_start}} km</td>
                                                    <td>{{$item->odometer_end}} km</td>
                                                    <td>{{$item->no_kim}} km</td>
                                                </tr>
