    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <i class="fa fa-certificate"></i> TOP 10 <small>&nbsp;&nbsp;Dispatch distribution per department</small>
                </h3>
            </div>
        </div>
                            ...
                            <div class="tab-pane active">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <form role="form" action="{{route('vehicle.report.dipstachdepartment')}}" method="GET">
                                        <div class="col-md-3">
                                    ...
                                    <ul class="list-inline">
                                        <li>
                                            <form method="POST" action="{{route('vehicle.report.exportToExcel')}} ">
                                                ...
                                                <button class="btn btn-circle blue" name="per_dept" id="excel-b"><i class="fa fa-file-excel-o"></i> Excel</button>
                                            </form>
                                        </li>
                                        <li>
    ...
    <script>
        FusionCharts.ready(function() {
            var revenueChart = new FusionCharts({
                ...
                dataSource: {
                    "chart": {
                        "caption": "Dispatches Distribution per Department",
